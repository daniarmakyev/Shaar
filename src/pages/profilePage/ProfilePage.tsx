...
const ProfilePage: FC = () => {
  ...
  const changeUserFunc: SubmitHandler<IUser> = async ({
    email,
    username,
    firstName,
    lastName,
          ...
          <div className="sm:w-[41%] flex flex-col justify-between">
            <div className=" justify-center flex flex-col items-center sm:gap-y-5">
              <img
                src={avatarBasic}
                alt="avatar"
                className="w-28 h-28 sm:w-24 sm:h-24 md:w-40 md:h-40 rounded-full absolute top-[-40px] bg-white p-2 sm:static"
              />
          ...
          <form className="w-full scrollbar-visible p-3 overflow-auto flex-col  bg-white rounded-lg ">
            ...
            <div className="sm:text-18 font-semibold  gap-5 justify-center bottom-9 flex mt-8">
              ...
              <button
                ...
                type="submit"
                onClick={handleSubmit(changeUserFunc)}
            ...
            <ul className="flex flex-col gap-4">
              <li className="flex flex-col">
                ...
                <ProfileInput
                  ...
                  className="border-b p-2 text-grey border-grey focus:outline-none focus:border-green transition-colors"
                />
              </li>
              <li className="flex flex-col">
                <label
